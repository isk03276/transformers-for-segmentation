...
class UnetR(BaseModel):
    def __init__(self,
        ...
        super().__init__(image_size=image_size, n_channel=n_channel, n_patch=n_patch, n_dim=n_dim, n_encoder_blocks=n_encoder_blocks, n_heads=n_heads, use_cnn_embedding=use_cnn_embedding)
        
        self.patch_embedder = PatchEmbedder(image_size=self.image_size,
